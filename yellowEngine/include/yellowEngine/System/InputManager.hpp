...
namespace yellowEngine
{
	...
	private:
		...
		static constexpr int Num_MouseButtons = MOUSE_BUTTON_LAST;
		...
		~InputManager();
		void initMousePosition(float x, float y);
		void update();
		...
		// there might be more than one key event in one frame; so use set instead of vector
		std::set<int> _changedKeys;
