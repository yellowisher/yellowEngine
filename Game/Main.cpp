...
//	{
//		auto model = Model::create("./res/Mesh/Units/infantry.fbx");
//		GameObject* unitObject = model->instantiate("Unit0");
//		Unit* unit = unitObject->addComponent<Unit>();
//		unit->type = Unit::Unit_Sword;
//		unit->hp = 100;
//		unit->defense = 0;
//		unit->moveSpeed = 0.05f;
//		unit->damage[0] = 20;
//		unit->attackDelay = 30;
//		unit->moveClip = Unit::Clip_Run;
//		unit->deathClip = Unit::Clip_Death_A;
//
//		unitObject->addComponent<Animator>();
//		unitObject->addComponent<BoxCollider>()->setSize(100.0f, 100.0f, 100.0f);
//		unitObject->transform->setPosition(-100.0f, -100.0f, -100.0f);
//		unitObject->transform->setScale(0.01f, 0.01f, 0.01f);
//
//		GameObject* spawnerObject0 = GameObject::find("Castle");
//		spawner0 = spawnerObject0->addComponent<Spawner>();
//		spawner0->team = 0;
//
//		GameObject* spawnerObject1 = GameObject::find("Enemy Castle");
//		spawner1 = spawnerObject1->addComponent<Spawner>();
//		spawner1->team = 1;
//	}
//
//	void update() override
...
//		{
//			spawner0->spawn(Unit::Unit_Sword);
//		}
//
//		if (InputManager::getKeyDown(GLFW_KEY_2))
//		{
//			spawner1->spawn(Unit::Unit_Sword);
//		}
//	}
//};
//
...
//	cameraGo->addComponent<LightScript>();
//
//	////////// Scene end
//
